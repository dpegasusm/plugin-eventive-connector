 ...
 */
function eventive_native_year_round( $atts = array() ) {
	// Read settings
	...
	} elseif ( wp_script_is( 'eventive-loader', 'registered' ) && ! wp_script_is( 'eventive-loader', 'enqueued' ) ) {
	...
	wp_register_script(
		...
		plugin_dir_url( __DIR__ ) . 'js/eventive-native-year-round.js',
