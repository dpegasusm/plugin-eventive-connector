	...
	return (
		...
		>
			<TextControl
				...
				onChange={(value) => updateMeta('_eventive_film_id', value)}
			...
			<TextControl
				...
				onChange={(value) => updateMeta('_eventive_director', value)}
			/>
			...
			<TextControl
				...
				onChange={(value) => updateMeta('_eventive_runtime', value)}
				type="number"
			/>
			...
			<TextControl
				...
				onChange={(value) => updateMeta('_eventive_language', value)}
			/>

			<TextControl
				label={__('Country of Origin', 'eventive')}
				value={meta._eventive_country || ''}
				onChange={(value) => updateMeta('_eventive_country', value)}
			/>

			<TextControl
				label={__('Poster Image URL', 'eventive')}
				value={meta._eventive_poster_image || ''}
				onChange={(value) => updateMeta('_eventive_poster_image', value)}
				type="url"
			/>
			...
			<TextControl
				...
				onChange={(value) => updateMeta('_eventive_cover_image', value)}
				type="url"
			/>
			...
			<TextControl
				...
				onChange={(value) => updateMeta('_eventive_trailer_url', value)}
				type="url"
			/>
		</PluginDocumentSettingPanel>
	);
