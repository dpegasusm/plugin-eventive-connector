...
class Eventive_Buttons {
	public function __construct() {
		add_action( 'admin_menu', array( $this, 'add_button_designer_submenu' ) );
		add_action( 'admin_init', array( $this, 'register_settings' ) );
		add_action( 'wp_head', array( $this, 'generate_dynamic_css' ), 99 );
	}
	...
	public function add_button_designer_submenu() {
		add_submenu_page(
			...
			array( $this, 'render_button_designer_page' )
		);
	}
