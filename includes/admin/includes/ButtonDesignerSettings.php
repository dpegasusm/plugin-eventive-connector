...
class ButtonDesignerSettings {
	...
	private static function add_fields() {
		add_settings_field( 'button_background_color', 'Button Background Color', array( self::class, 'background_color_field' ), 'eventive-button-designer', 'button_designer_settings_section' );
		add_settings_field( 'button_hover_color', 'Button Hover Color', array( self::class, 'hover_color_field' ), 'eventive-button-designer', 'button_designer_settings_section' );
		add_settings_field( 'button_font', 'Button Font Family', array( self::class, 'font_field' ), 'eventive-button-designer', 'button_designer_settings_section' );
		add_settings_field( 'button_text_color', 'Button Text Color', array( self::class, 'text_color_field' ), 'eventive-button-designer', 'button_designer_settings_section' );
		add_settings_field( 'button_border_color', 'Button Border Color', array( self::class, 'border_color_field' ), 'eventive-button-designer', 'button_designer_settings_section' );
		add_settings_field( 'button_border_width', 'Button Border Width (px)', array( self::class, 'border_width_field' ), 'eventive-button-designer', 'button_designer_settings_section' );
		add_settings_field( 'button_border_style', 'Button Border Style', array( self::class, 'border_style_field' ), 'eventive-button-designer', 'button_designer_settings_section' );
		add_settings_field( 'button_border_radius', 'Button Border Radius (px)', array( self::class, 'border_radius_field' ), 'eventive-button-designer', 'button_designer_settings_section' );
		add_settings_field( 'button_box_shadow', 'Button Box Shadow (CSS)', array( self::class, 'box_shadow_field' ), 'eventive-button-designer', 'button_designer_settings_section' );
	}

	public static function background_color_field() {
		$options = get_option( 'eventive_button_designer_options', array() );
