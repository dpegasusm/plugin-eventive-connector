...
function eventive_account_tickets_shortcode() {
	...
	wp_enqueue_script(
		'eventive-utils',
		plugin_dir_url( __DIR__ ) . 'js/eventive-utils.js',
		array(),
		'1.0.1',
		true
	);
	...
	wp_enqueue_style(
		...
		plugin_dir_url( __DIR__ ) . 'css/eventive-account-tickets.css',
		array(),
		'1.0.1'
	);
	...
	wp_register_script(
		...
		plugin_dir_url( __DIR__ ) . 'js/eventive-account-tickets.js',
